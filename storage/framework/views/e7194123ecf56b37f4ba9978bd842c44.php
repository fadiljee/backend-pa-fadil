        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    <p class="mb-0 text-white-50">Selamat datang kembali, <?php echo e(Session::get('ambilUser')->nama); ?>!</p>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="stats-card animate-slide-up">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="stats-number"><?php echo e($jumlahSiswa); ?></div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="stats-card bg-success animate-slide-up" style="animation-delay: 0.1s;">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="stats-number"><?php echo e($jumlahMateri); ?></div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="stats-card bg-warning animate-slide-up" style="animation-delay: 0.2s;">
                        <div class="d-flex align-items-center text-dark">
                            ...
                            <div>
                                <div class="stats-number"><?php echo e($jumlahQuiz); ?></div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card animate-slide-up" style="animation-delay: 0.4s;">
                        ...
                        <div class="card-body">
                            <a href="<?php echo e(route('tambahSiswa')); ?>" class="btn btn-primary btn-block mb-2">
                                <i class="fas fa-user-plus mr-2"></i>Tambah Siswa Baru
                            </a>
                            <a href="<?php echo e(route('tambahMateri')); ?>" class="btn btn-success btn-block mb-2">
                                <i class="fas fa-plus-circle mr-2"></i>Tambah Materi Baru
                            </a>
                            <a href="<?php echo e(route('tambahkuis')); ?>" class="btn btn-warning btn-block text-dark">
