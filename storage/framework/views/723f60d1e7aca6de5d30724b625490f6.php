            ...
            <div class="row align-items-center">
                <div class="col-sm-8">
                    ...
                    <p class="mb-0 text-white-50 text-truncate">
                        Anda sedang mengubah pertanyaan: <strong>"<?php echo e($kuis->pertanyaan); ?>"</strong>
                    </p>
                </div>
                <div class="col-sm-4">
                            ...
                            <div class="card-body p-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="pertanyaan" name="pertanyaan" value="<?php echo e(old('pertanyaan', $kuis->pertanyaan)); ?>" required>
                                    </div>
                                </div>
