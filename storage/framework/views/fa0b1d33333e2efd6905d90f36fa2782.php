...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
  <div class="wrapper">
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?php echo e(asset('gambar/icon.jpg')); ?>" alt="SchoolLogo" height="80" width="80" style="border-radius: 50%;">
    </div>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="ml-1"><?php echo e(Session::get('ambilUser')->nama); ?></span>
                </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
     <a href="<?php echo e(route('dashboardadmin')); ?>" class="brand-link text-center" title="Dashboard SMPN 1 Merawang">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="#" class="text-dark">SMP Negeri 1 Merawang</a>.</strong>
    </footer>
