        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    <p class="mb-0 text-white-50">Memperbarui informasi untuk siswa: <strong><?php echo e($user->nama); ?></strong></p>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="card-body p-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo e(old('nama', $user->nama)); ?>" placeholder="Masukkan Nama Lengkap Siswa" required>
                                    </div>
                                </div>
