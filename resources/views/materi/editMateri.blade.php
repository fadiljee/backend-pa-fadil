            ...
            <div class="row align-items-center">
                <div class="col-sm-8">
                    ...
                    <p class="mb-0 text-white-50">
                        Anda sedang mengubah materi: <strong>{{ $materi->judul }}</strong>
                    </p>
                </div>
                <div class="col-sm-4">
                        ...
                        <form action="{{ route('updatemateri', $materi->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="konten" name="konten" rows="8" required>{{ old('konten', $materi->konten) }}</textarea>
                                </div>
                                ...
                                @if($materi->gambar)
                                  <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/' . $materi->gambar) }}" alt="Gambar Materi" class="img-fluid rounded shadow-sm" style="max-width: 250px; border: 1px solid #ddd; padding: 5px;">
                                    </div>
                                  </div>
                                @endif
