                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Masukkan Nama Lengkap Siswa" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="nisn" name="nisn" value="{{ old('nisn') }}" placeholder="Masukkan Nomor Induk Siswa Nasional" required>
                                    </div>
